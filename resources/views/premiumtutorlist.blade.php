            ...
            <div class="right-side">
                ...
                <div class="tutor-search-result">
                    ...
                    <div class="result-body">
                        <div class="container">
                            <div class="row">
                                @foreach ($premium_tutors as $tutoruser)
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="result-card">
                                        ...
                                        <div class="footer">
                                           @guest
                                           <a class="tutorlist-profiile-details" href="{{route('guest.tutorprofilepublicview',$tutoruser->getuser->id)}}">View
                                           Details</a>
                                           @else
                                           @if(Auth::user()->is_gurdian =='1')
                                           <a class="tutorlist-profiile-details" href="{{route('gurdian.singletutor',$tutoruser->getuser->id)}}">View
                                           Details</a>
                                           @else
