                                ...
                                @else
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-12">
                                        <div class="result-card">
                                            ...
                                            <div class="body">
                                                <div class="left">
                                                    <div class="profile-image">
                                                        <img src="{{ asset($searchtutor->getuser->profile_image) }}" alt=""
                                                            srcset="">
                                                    </div>
                                                </div>
                                                <div class="right">
                                            ...
                                            <div class="footer">
                                                <a class="tutorlist-profiile-details" href="{{route('guest.tutorprofilepublicview',$searchtutor->getuser->id)}}">View
                                                    Details</a>
                                            </div>
                                        </div>
                                    </div>
