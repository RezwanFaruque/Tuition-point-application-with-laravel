                ...
                <form action="{{route('admin.savetutions')}}" method="POST">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <select class="select2-single form-control col-sm-8" name="student_gender" id="select2Single">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <select class="select2-single form-control col-sm-8" name="days_per_week" id="select2Single">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control" name="address" placeholder="Address Ex: Dhaka Mirpur" type="text">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control" name="location" placeholder="Locatioin" type="text">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <select class="select2-single form-control col-sm-8" name="desire_tutor_gender" id="select2Single">
                                    <option value="" hidden selected>Select Gemder</option>
                                    <option value="male">Male</option>
                                    <option value="female">Female</option>
                                </select>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control" name="salary_range" placeholder="Salary Range Ex. 5000-6000" type="text">
                            </div>
                        </div>
                    </div>
